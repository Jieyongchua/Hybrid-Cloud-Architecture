...
python3 drift-detector/ai-agent/agent.py drift-detector/fixtures/sample.diff
python3 drift-detector/ai-agent/agent.py drift-detector/fixtures/sample_plan.json
